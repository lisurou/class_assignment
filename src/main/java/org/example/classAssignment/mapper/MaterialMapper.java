...
public interface MaterialMapper {
    @Select("select * from course_material_folder where course_id=#{courseId}")
    List<MaterialFolder> findFoldersByCourseId(String courseId);
    ...
    @Insert("insert into course_material_folder(course_id,parent_id,name,created_by,created_at) values(#{courseId},#{parentId},#{name},#{createdBy},now())")
    ...
    @Select("select * from course_material_attachment where course_id=#{courseId}")
    List<MaterialAttachment> findAttachmentsByCourseId(String courseId);
    ...
    @Insert("insert into course_material_attachment(course_id,folder_id,original_name,stored_name,relative_path,size,content_type,created_by,created_at) values(#{courseId},#{folderId},#{originalName},#{storedName},#{relativePath},#{size},#{contentType},#{createdBy},now())")
    ...
    @Select("select * from course_material_link where course_id=#{courseId}")
    List<MaterialLink> findLinksByCourseId(String courseId);
    ...
    @Insert("insert into course_material_link(course_id,folder_id,title,url,created_by,created_at) values(#{courseId},#{folderId},#{title},#{url},#{createdBy},now())")
